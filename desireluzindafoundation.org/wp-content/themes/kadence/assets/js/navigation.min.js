    ...
    function() {
        ...
        window.kadence = {
                ...
                if (t.length)
                    for (let n = 0; n < t.length; n++) {
                        ...
                        e && (e.addEventListener("click", (function(e) {
                            e.preventDefault(), e.target.parentNode.parentNode.parentNode.parentNode.classList.contains("menu-item") ? window.kadence.toggleSubMenu(e.target.parentNode.parentNode.parentNode.parentNode) : window.kadence.toggleSubMenu(e.target.parentNode.parentNode.parentNode)
            ...
            toggleDrawer: function(e, t) {
                ...
                else if (n.classList.add("show-drawer"), o.dataset.toggleBodyClass && i.body.classList.toggle(o.dataset.toggleBodyClass), setTimeout((function() {
            ...
            initStickyHeader: function() {
                var e = document.querySelector("#main-header .kadence-sticky-header"),
                    ...
                    r = 0,
                    l = 0;
                kadenceConfig.breakPoints.desktop <= window.innerWidth ? (a = "desktop", e && (e.style.position = "static", l = window.kadence.getOffset(e).top, e.style.position = null)) : t && (t.style.position = "static", l = window.kadence.getOffset(t).top, t.style.position = null);
                var s, d, c, u = function(s) {
                    ...
                    if (d = kadenceConfig.breakPoints.desktop <= window.innerWidth ? e : t) {
                        ...
                        if ((!m || s && void 0 !== s.type && "orientationchange" === s.type) && (d.setAttribute("data-start-height", d.offsetHeight), m = d.offsetHeight, h.classList.contains("site-header-upper-inner-wrap") ? (h.style.height = null, s && void 0 !== s.type && "orientationchange" === s.type ? d.classList.contains("item-is-fixed") ? setTimeout((function() {
                            ...
                            if (v) {
                                if ("true" === w)
                                    if (window.scrollY > r) var y = Math.floor(Math.floor(l) - Math.floor(c) + Math.floor(m));
                        ...
                        if ("true" === w) {
                            var E = Math.floor(l - c),
                                ...
                                A = d.offsetHeight,
                                M = r - T,
                                q = window.getComputedStyle(d).getPropertyValue("transform").match(/(-?[0-9\.]+)/g);
                            if (q && void 0 !== q[5] && q[5]) var H = parseInt(q[5]) + M;
                            else H = 0;
                            var N = T > r;
                            if (T <= E) d.style.transform = "translateY(0px)";
                            else if (N) d.classList.add("item-hidden-above"), d.style.transform = "translateY(" + (Math.abs(H) > A ? -A : H) + "px)";
                            else {
                                E = Math.floor(l - c);
            ...
            getTopOffset: function() {
                ...
                if (kadenceConfig.breakPoints.desktop <= window.innerWidth) {
                    if (e) o = "true" !== e.getAttribute("data-shrink") || e.classList.contains("site-header-inner-wrap") ? Math.floor(e.offsetHeight) : Math.floor(e.getAttribute("data-shrink-height"));
                    else o = 0;
